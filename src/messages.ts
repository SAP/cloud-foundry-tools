...
export const messages = {
  ...
  no_services_instance_byname_found: (name: string): string => `No service instance ${name} found`,
  ...
  no_services_instances_found_for_type: (name: string): string => `No service instances found for ${name} type`,
