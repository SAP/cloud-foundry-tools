...
export const messages = {
  ...
  creating_service: (instanceName: string, servieInfoLabel: string, planInfoLabel: string): string => `Creating the ${instanceName}(${servieInfoLabel} - ${planInfoLabel}) service...`,
  ...
  error_service_params_max_length: (name: string, length: number): string => `The ${name} may be composed of up to ${length} characters`,
  ...
  no_service_plan_info_found: (plan: string, service: string): string => `Could not find the ${plan} service plan info for the ${service} service`,
  ...
  target_setup_not_completed: (org: string|undefined, space: string|undefined): string => `The CF target definition is incomplete - org='${org}', space='${space}'. Do you want to continue?`,
