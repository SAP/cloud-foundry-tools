...
describe("cfView tests", () => {
    ...
    describe("CFView ", () => {
        ...
        it("ok:: verify getChildren - target, not active", async () => {
            ...
            const expected = [new cfView.CFServicesFolder("Services", instance.targets[0]), new cfView.CFAppsFolder("Applications", instance.targets[0])];
        ...
        it("ok:: verify getChildren - target/services, is active", async () => {
            ...
            const services = [{ label: 's-1', serviceName: 'name-1' }, { label: 's-2', serviceName: 'name-2' }];
        ...
        it("ok:: verify getChildren - target/applications, is active", async () => {
            ...
            const apps = [{ name: 'a-1', state: 'STARTED' }, { name: 'a-2', state: 'STOPPED' }];
